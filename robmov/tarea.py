...
class ReadImage( Node ):
    ...
    def __init__( self ):
        ...
        self.bg = CvBridge()
        self.kinect_image_sub   = self.create_subscription( Image, '/camera', self.image_reader, 1 )
        self.position_pub       = self.create_publisher( Twist, '/motors', 1 )
        ...
        self.mask = 1
        self.ready = 1
        self.mask_b = np.array([  6,  48, 126])
        self.mask_t = np.array([ 53, 145, 226])
        self.n = 4
